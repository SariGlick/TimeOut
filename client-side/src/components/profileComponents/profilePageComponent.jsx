...
// ייבוא אייקונים וחבילות UI
import { Delete as DeleteIcon, Edit as EditIcon, Save as SaveIcon, Cancel as CancelIcon } from '@mui/icons-material';

// ייבוא קומפוננטים מותאמים אישית
import Select from '../../stories/Select/Select.jsx';
import TableComponent from '../../stories/table/TableComponent.jsx';
import ToastMessage from '../../stories/Toast/ToastMessage.jsx';
import Loader from '../../stories/loader/loader.jsx';
    ...
    <div className="profile-page-container">
      <div className="select-container">
        <Select
          ...
          label="בחר פרופיל"
          options={profiles.map((profile) => ({ value: profile._id, label: profile.profileName }))}
        />
      </div>
      {loading ? (
        <Loader />
        ...
        selectedProfile && (
          <>
            <TableComponent
              data={selectedProfile.listWebsites}
              ...
              ProfileActivationTimer={ProfileActivationTimer}
            />
            <AddProfileComponent userId={userId} />
